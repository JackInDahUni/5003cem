...
##################################################################################
                ...
                if self.graph[u][v] > 0 and not mstSet[v] and self.graph[u][v] < key[v]: #if edge from u to connected node v is > 0 (if there is an edge)
                    key[v] = self.graph[u][v]                                            #and mstSet[v] is unreached 
